...
namespace {
struct qt_meta_stringdata_NE_Node_t {
    uint offsetsAndSizes[2];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NE_Node_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_NE_Node_t qt_meta_stringdata_NE_Node = {
    {
        QT_MOC_LITERAL(0, 7)   // "NE_Node"
    },
    "NE_Node"
};
#undef QT_MOC_LITERAL
...
Q_CONSTINIT static const uint qt_meta_data_NE_Node[] = {
...
Q_CONSTINIT const QMetaObject NE_Node::staticMetaObject = { {
    QMetaObject::SuperData::link<NE_Node_Basic::staticMetaObject>(),
    qt_meta_stringdata_NE_Node.offsetsAndSizes,
    qt_meta_data_NE_Node,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_NE_Node_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NE_Node, std::true_type>
    >,
    nullptr
} };

void NE_Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
const QMetaObject *NE_Node::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NE_Node::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_NE_Node.stringdata0))
        return static_cast<void*>(this);
    return NE_Node_Basic::qt_metacast(_clname);
}

int NE_Node::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = NE_Node_Basic::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
